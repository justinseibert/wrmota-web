var Brick = function(args){
  ...
  var canvasDummy = document.getElementById('canvasDummy');
  ...
  var util = {
    ...
    scale: function(){
      ...
      canvasDummy.style.height = (canvas.clientHeight+10)+'px';
    ...
    afterPrint: function(){
      ...
      paper.projects[0].activeLayer.children[0].children['transit-line'].fullySelected = true;
    },
  ...
  user.draw = {
    ...
    subtractor: function(){
      if (user.args.subtract){
        subtractor.innerHTML = '+',
        user.args.subtract = false;
      } else {
        subtractor.innerHTML = '-',
        user.args.subtract = true;
      }
    }
  }
  ...
  action.onMouseDown = function(event) {
    paper.project.activeLayer.fullySelected = true;
      ...
      if (result.type == 'segment') {
        ...
        if ((event.modifiers.shift||user.args.subtract) && hit.segment){
          hit.segment.remove();
        }
  ...
  user.print = function(){
    ...
    active_layer.children['transit-line'].fullySelected = false;
    ...
    console.log(layer_cache.children['transit-line 1'].fullySelected);
